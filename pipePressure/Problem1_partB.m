...
grid on
title('Theta Velocity vs Radius - Part B')
xlabel('radius (m)')
ylabel('v {theta} (m/s)')
...
plot(r,P/1000)
grid on
title('Pressure vs Radius - Part B')
xlabel('radius (m)')
ylabel('P(r) (kPa)')
...
figure(3)
quiver(x, y, u, v)
title('Velocity Field in Pipe Cross-section (m/s) - Part B')
hold on
...
figure(4);
pcolor(x, y, P/1000);
title('Pressure Gradient in the Pipe (kPa) - Part B')
